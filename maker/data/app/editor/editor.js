(function () {
    ...
    editor.directive('wgmCropper', function () {
        var directive = {
            restrict: 'C',
            ...
            link: function (scope, element, attrs, ctrl) {
                ...
                canvas.on('mouse:down', function (options) {
                    ...
                    rect.set({
                        left: options.e.clientX - canBounds.left,
                        top: options.e.clientY - canBounds.top
                    });
                ...
                canvas.on('mouse:move', function (options) {
                    if (isMouseDown) {
                        var canBounds = element[0].getBoundingClientRect();
                        rect.set({
                            width: options.e.clientX - rect.left - canBounds.left,
                            height: options.e.clientY - rect.top - canBounds.top
                        });
                        canvas.renderAll();
                    }
                });
